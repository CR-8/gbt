          ...
          {features.map((feature: Feature) => (
            ...
            >
              <div className="flex justify-center gap-10 border-neutral-500 border-b">
                ...
                <div className="md:w-1/3 w-2/5 shrink-0 rounded-r-lg border-l border-neutral-500 relative">
                  <Image
                    src={feature.image || "https://plus.unsplash.com/premium_photo-1744607693346-5d31a2a15733?q=80&w=1171&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"}
                    alt={feature.title}
                    fill
